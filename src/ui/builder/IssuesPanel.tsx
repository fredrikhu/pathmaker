...
export function IssuesPanel({ issues, onNavigate, onClear }: {
  ...
  return (
    <div className="issues-panel" style={{ borderLeft: '1px solid var(--color-divider)', padding: 18, display: 'flex', flexDirection: 'column', gap: 10, background: 'var(--color-surface)', minHeight: 0, overflowY: 'auto' }}>
