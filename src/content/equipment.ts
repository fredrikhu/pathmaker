...
export const ARMORS: ArmorDef[] = [
  ...
  { id: 'hide', name: 'Hide armor', cost: 15, weight: 25, acBonus: 4, maxDex: 4, acp: -3, asf: 20, slot: 'armor', category: 'medium' },
  ...
  { id: 'splint-mail', name: 'Splint mail', cost: 200, weight: 45, acBonus: 7, maxDex: 0, acp: -7, asf: 40, slot: 'armor', category: 'heavy' },
  { id: 'banded-mail', name: 'Banded mail', cost: 250, weight: 35, acBonus: 7, maxDex: 1, acp: -6, asf: 35, slot: 'armor', category: 'heavy' },
  { id: 'half-plate', name: 'Half-plate', cost: 600, weight: 50, acBonus: 8, maxDex: 0, acp: -7, asf: 40, slot: 'armor', category: 'heavy' },
  ...
  { id: 'light-steel-shield', name: 'Light steel shield', cost: 9, weight: 6, acBonus: 1, maxDex: null, acp: -1, asf: 5, slot: 'shield', category: 'shield' },
  { id: 'heavy-shield', name: 'Heavy wooden shield', cost: 7, weight: 10, acBonus: 2, maxDex: null, acp: -2, asf: 15, slot: 'shield', category: 'shield' },
  { id: 'heavy-steel-shield', name: 'Heavy steel shield', cost: 20, weight: 15, acBonus: 2, maxDex: null, acp: -2, asf: 15, slot: 'shield', category: 'shield' },
  { id: 'tower-shield', name: 'Tower shield', cost: 30, weight: 45, acBonus: 4, maxDex: 2, acp: -10, asf: 50, slot: 'shield', category: 'shield' },
];
...
export const GEAR: GearDef[] = [
  ...
  // --- General adventuring gear (Core equipment table) ---
  { id: 'rope-silk', name: 'Rope, silk (50 ft)', cost: 10, weight: 5, note: '+2 vs breaking over hemp' },
  { id: 'grappling-hook', name: 'Grappling hook', cost: 1, weight: 4 },
  { id: 'crowbar', name: 'Crowbar', cost: 2, weight: 5, note: '+2 on Strength checks to force it' },
  { id: 'hammer', name: 'Hammer', cost: 0.5, weight: 2 },
  { id: 'piton', name: 'Piton', cost: 0.1, weight: 0.5 },
  { id: 'lantern-hooded', name: 'Lantern, hooded', cost: 7, weight: 2, note: 'bright light 30 ft; burns oil' },
  { id: 'lantern-bullseye', name: 'Lantern, bullseye', cost: 12, weight: 3, note: 'bright light in a 60-ft cone; burns oil' },
  { id: 'oil-flask', name: 'Oil (1-pint flask)', cost: 0.1, weight: 1, consumable: true, note: 'fuels a lantern 6 hours, or a thrown improvised fire' },
  { id: 'candle', name: 'Candle', cost: 0.01, weight: 0, consumable: true, note: 'dim light 5 ft for 1 hour' },
  { id: 'chalk', name: 'Chalk (1 piece)', cost: 0.01, weight: 0, consumable: true },
  { id: 'sunrod', name: 'Sunrod', cost: 2, weight: 1, consumable: true, note: 'bright light 30 ft for 6 hours' },
  { id: 'smokestick', name: 'Smokestick', cost: 20, weight: 0.5, consumable: true, note: 'instant thick smoke in a 10-ft cube for 1 round' },
  { id: 'antitoxin', name: 'Antitoxin (vial)', cost: 50, weight: 0, consumable: true, note: '+5 alchemical bonus on saves vs poison for 1 hour' },
  { id: 'caltrops', name: 'Caltrops', cost: 1, weight: 2, note: 'scatter to injure and slow foes crossing a 5-ft square' },
  { id: 'manacles', name: 'Manacles', cost: 15, weight: 2, note: 'DC 30 Escape Artist / DC 26 Strength to break' },
  { id: 'mirror-steel', name: 'Mirror, small steel', cost: 10, weight: 0.5 },
  { id: 'pole-10ft', name: 'Pole (10 ft)', cost: 0.05, weight: 8 },
  { id: 'sack', name: 'Sack', cost: 0.1, weight: 0.5 },
  { id: 'belt-pouch', name: 'Pouch, belt', cost: 1, weight: 0.5 },
  { id: 'signal-whistle', name: 'Signal whistle', cost: 0.8, weight: 0 },
  { id: 'tent', name: 'Tent (small)', cost: 10, weight: 20, note: 'sleeps one' },
  { id: 'whetstone', name: 'Whetstone', cost: 0.02, weight: 1 },
  { id: 'climbers-kit', name: "Climber's kit", cost: 80, weight: 5, note: '+2 circumstance bonus on Climb checks' },
  { id: 'disguise-kit', name: 'Disguise kit', cost: 50, weight: 8, consumable: true, note: '+2 on Disguise; 10 uses' },
  { id: 'magnifying-glass', name: 'Magnifying glass', cost: 100, weight: 0, note: '+2 on Appraise for detailed items; can start fires' },
  { id: 'holy-symbol-silver', name: 'Holy symbol, silver', cost: 25, weight: 1 },
  { id: 'flask-ceramic', name: 'Flask (ceramic)', cost: 0.03, weight: 1.5, note: 'holds 1 pint of liquid' },
